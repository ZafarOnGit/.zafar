document.addEventListener('DOMContentLoaded', function() {
    ...
    const introSteps = [
        ...
        { erase: true, pause: 500 },
        { text: 'Welcome to my website.', pause: 1200 },
        { erase: true, pause: 700 },
    ...
    blogContentHandler = function(e) {
        if (e.key === 'Enter' || e.keyCode === 13) {
            ...
            if (val === 'clear' || val === 'reset') {
                ...
                typeAnim(o, "Type 'back' to return or 'exit' to close.", (typedDiv) => {
                    eraseAnim(typedDiv, "Type 'back' to return or 'exit' to close.", () => {
                        iEl.value = '';
                        iEl.focus();
                    }, 22);
                }, 32);
    ...
    async function handleCommand(cmd) {
        ...
        if (c === 'clear') {
            ...
            const skillsContent = 'My skills include:<br><br>- Software Development (Python, JavaScript, Go, Java)<br>- Web Technologies (HTML, CSS, React, Node.js)<br>- Cloud Platforms (AWS, Google Cloud)<br>- Databases (SQL, NoSQL)<br>- Machine Learning & AI Fundamentals<br><br>Always learning and expanding my expertise!';
            typeAnim(o, skillsContent, () => { /* Optional callback */ }, 16, false, true); // Fast typing for skills
        } else if (c === 'hobbies') {
            const hobbiesContent = 'When I\'m not coding, I enjoy:<br><br>- Exploring new tech gadgets<br>- Reading sci-fi and fantasy novels<br>- Playing video games (especially Minecraft, since I love building stuff!)<br>- Hiking and spending time in nature<br>- Learning new languages (currently dabbling in Japanese!)<br>- Following F1 racing (for the technology and fast cars that go vroom vroom!)<br><br>Life\'s an adventure, and I try to make the most of it!';
            typeAnim(o, hobbiesContent, () => { /* Optional callback */ }, 16, false, true); // Fast typing for hobbies
        } else if (c === 'whoami') {
    ...
    function typeStep(targetEl, steps, onDone, stepIndex = 0) {
        if (stepIndex < steps.length) {
            ...
            if (step.erase) {
                ...
                if (lastDiv) {
                    eraseAnim(lastDiv, lastDiv.textContent, () => { // Pass content for erase length
                        typeStep(targetEl, steps, onDone, stepIndex + 1);
                    }, 22); // Faster erase
                } else {
                    typeStep(targetEl, steps, onDone, stepIndex + 1); // If nothing to erase, just proceed
                }
            } else {
    ...
    function showBlogMenu() {
        ...
        typeAnim(o, menuHTML, () => {
            iEl.value = '';
            iEl.removeAttribute('disabled');
            // Remove all existing keydown listeners to ensure only one is active
            iEl.removeEventListener('keydown', mainInputHandler);
            iEl.removeEventListener('keydown', menuInputHandler);
            iEl.removeEventListener('keydown', blogContentHandler);
            iEl.removeEventListener('keydown', archiveHandler);

            // Add the specific menu handler after a short delay
            setTimeout(() => {
    ...
    function showBlogContent() {
        o.innerHTML = '';
        let blogHTML = `
            <div style='font-size:1.35em;font-weight:bold;margin-bottom:0.7em;text-align:center;letter-spacing:0.01em;color:#b5e853;'>First Entry: A Personal Milestone and New Beginnings</div>
            <div style='color:#aaa;font-size:0.98em;margin-bottom:1.5em;text-align:center;'>July 9th, 2025 &mdash; by Mohamed Zafar</div>
            <div style='margin-bottom:1.5em;line-height:1.7;'>
                Hello everyone! Welcome to my personal website and blog. Today feels like the perfect day to launch this space - not just because I'm officially going live with the site, but because I'm celebrating my 19th birthday today. What better way to mark this milestone than by sharing something I've been working on for quite some time?
            </div>
            <div style='margin-bottom:1.5em;line-height:1.7;'>
                For the past month and a half, I've been dedicated to building this personal website from the ground up. Now, I'll be honest - it took longer than I initially expected, but that's because I spent a significant amount of time learning along the way. Every challenge I encountered became a learning opportunity, and every bug I fixed taught me something valuable about web development.<br><br>
                <span style='color:#b5e853;'>Fun fact:</span> I probably consumed enough coffee during this process to power a small server farm. My keyboard has definitely seen some things.
            </div>
            <div style='display:flex;justify-content:center;align-items:center;margin-bottom:2em;'>
                <img src='IMG_20250708_131839.jpg' alt='Laptop with code editor in the dark' style='max-width:220px;width:100%;border-radius:10px;box-shadow:0 2px 16px #000a;margin:0 auto;border:2px solid #23272e;background:#111;padding:4px;display:block;'>
            </div>
            <div style='font-weight:bold;margin-bottom:0.5em;font-size:1.08em;color:#b5e853;'>The Journey Behind This Website</div>
            <div style='margin-bottom:1.5em;line-height:1.7;'>
                The process has been incredibly rewarding. From designing the layout to writing the code, debugging issues, and fine-tuning the user experience - each step has been a chance to grow as a developer and creator. Plus, I've gotten really good at talking to my computer screen when the code doesn't cooperate (it's surprisingly therapeutic).
            </div>
            <div style='font-weight:bold;margin-bottom:0.5em;font-size:1.08em;color:#b5e853;'>A Meaningful Gift</div>
            <div style='margin-bottom:1.5em;line-height:1.7;'>
                One of the most touching moments in this journey came when my dad saw my dedication to another project I'd been working on - a KEAM rank predictor tool. After witnessing the late nights, the problem-solving sessions, and my genuine passion for creating something useful (and probably my dramatic sighs when debugging), he offered to buy me this domain. Having that kind of support and recognition from family means everything to me.<br><br>
                That previous project taught me so much about data analysis, user interface design, and the importance of creating tools that genuinely help people. It was a stepping stone that led me here, to this personal space where I can share my thoughts, projects, and experiences - and maybe some of my coding mishaps that turned into happy accidents.
            </div>
            <div style='font-weight:bold;margin-bottom:0.5em;font-size:1.08em;color:#b5e853;'>Let's Connect and Grow Together</div>
            <div style='margin-bottom:1.5em;line-height:1.7;'>
                Here's something that would truly make this journey even more meaningful: your feedback and suggestions. If you've read this far, you're already part of this community I'm building. I'd love to hear from you! Seriously, even if it's just to tell me my color scheme needs work or that you spotted a typo - I'm all ears!<br><br>
                <span style='color:#e0e0e0;'>Whether you have suggestions for topics or feedback on projects, or just want to connect or share your coding stories, please reach out through the contact section on this website. Your input would be incredibly motivating!</span>
            </div>
            <div style='font-weight:bold;margin-bottom:0.5em;font-size:1.08em;color:#b5e853;'>Looking Forward</div>
            <div style='margin-bottom:1.5em;line-height:1.7;'>
                Turning 19 feels like stepping into a new chapter, and launching this website feels like the perfect way to document that journey. I'm excited about the projects I have planned, the things I'll learn, and the connections I'll make along the way.<br><br>
                Who knows? Maybe by my 20th birthday, I'll have figured out why CSS sometimes has a mind of its own. A developer can dream, right?
            </div>
            <div style='margin-bottom:1.5em;line-height:1.7;'>
                Thank you for being here at the beginning of this adventure. Here's to regular updates, continuous learning, building something meaningful together, and hopefully sharing some laughs along the way!
            </div>
            <div style='margin-bottom:1.5em;font-style:italic;text-align:right;color:#b5e853;'>Mohamed Zafar</div>
            <div style='margin-bottom:1.5em;color:#aaa;font-size:0.98em;'>Have thoughts, suggestions, or just want to connect? I'd love to hear from you - check out my contacts page and let's start a conversation!</div>
            <div style='margin-top:2em;color:#888;text-align:center;'>Type <b>back</b> to return or <b>exit</b> to close.</div>
        `;
        typeAnim(o, blogHTML, (typedDiv) => {
            iEl.value = '';
            iEl.removeAttribute('disabled');
            // Remove all existing keydown listeners to ensure only one is active
            iEl.removeEventListener('keydown', mainInputHandler);
            ...
            // Add the specific blog content handler after a short delay
            setTimeout(() => {
    ...
    function showArchive() {
        ...
        // Add the specific archive handler after a short delay
        setTimeout(() => {
